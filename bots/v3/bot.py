...
from bots.v3.army_coherence import ArmyCoherenceManager
from bots.v3.build_backlog import BuildBacklog
from bots.v3.build_orders import BuildOrder
from bots.v3.claude_advisor import ClaudeAdvisor, build_prompt
from bots.v3.commands import (
    CommandExecutor,
    CommandMode,
    CommandSource,
    filter_executable,
...
from bots.v3.commands.dispatch_guard import DispatchGuard
from bots.v3.console import print_status
from bots.v3.decision_engine import DecisionEngine, GameSnapshot, StrategicState
from bots.v3.fortification import FortificationManager
from bots.v3.give_up import (
    GIVE_UP_PROB_THRESHOLD,
    GIVE_UP_WINDOW,
    should_give_up,
)
from bots.v3.learning import winprob_heuristic
from bots.v3.learning.features import _FEATURE_SPEC
from bots.v3.learning.neural_engine import DecisionMode, NeuralDecisionEngine
from bots.v3.learning.rewards import RewardCalculator
from bots.v3.learning.threat_classes import THREAT_CLASS_MAP
from bots.v3.logger import GameLogger
from bots.v3.macro_manager import MacroDecision, MacroManager
from bots.v3.micro import MicroController
from bots.v3.observer import observe
from bots.v3.scouting import ScoutManager
from bots.v3.web_socket import queue_broadcast, queue_command_event

if TYPE_CHECKING:
    from bots.v3.learning.database import TrainingDB
