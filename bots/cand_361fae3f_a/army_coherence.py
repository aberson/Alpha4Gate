...
class ArmyCoherenceManager:
    ...
    def __init__(self, seed: int | None = None) -> None:
        ...
        # If attack_supply_floor > 35 somehow, cap it (shouldn't happen with range)
        self.attack_supply_floor = min(self.attack_supply_floor, 35.0)
