...
from bots.cand_361fae3f_a.audit_log import record_decision
from bots.cand_361fae3f_a.commands.primitives import (
    CommandAction,
    CommandPrimitive,
    CommandSource,
)
...
if TYPE_CHECKING:
    from bots.cand_361fae3f_a.web_socket import ConnectionManager
...
PROMPT_TEMPLATE = (
    ...
    "Meta-rule: Protoss is strongest when the army is coherent, the economy "
    "is healthy, the tech path is purposeful, and the fight is taken on "
    "favorable terms. Avoid chaos you did not choose; force the opponent to "
    "fight into your timing, your tech, and your positioning.\n\n"
    "Game time: {game_time}\n"
