...
from bots.cand_361fae3f_a.config import Settings, load_settings
...
def _ensure_pretrain_checkpoint(settings: Settings, hyperparams_path: Path) -> None:
    ...
    from bots.cand_361fae3f_a.learning.imitation import run_imitation_training
...
def _run_training(settings: Settings, args: argparse.Namespace) -> None:
    ...
    if args.train == "imitation":
        ...
        from bots.cand_361fae3f_a.learning.trainer import TrainingOrchestrator
...
def _start_server(settings: Settings, daemon: bool = False) -> None:
    ...
    from bots.cand_361fae3f_a.api import configure
    from bots.cand_361fae3f_a.error_log import install_error_log_handler
    ...
    if daemon:
        from bots.cand_361fae3f_a.api import _daemon
...
def _run_single_game(
    ...
    *,
    ...
    from bots.cand_361fae3f_a.bot import Alpha4GateBot
    from bots.cand_361fae3f_a.connection import run_bot
    from bots.cand_361fae3f_a.learning.neural_engine import DecisionMode
    ...
    if args.no_claude:
        ...
        from bots.cand_361fae3f_a.api import ws_manager
        from bots.cand_361fae3f_a.claude_advisor import ClaudeAdvisor
...
def _run_batch(settings: Settings, args: argparse.Namespace) -> None:
    ...
    from bots.cand_361fae3f_a.batch_runner import load_stats, record_game, save_stats
    from bots.cand_361fae3f_a.bot import Alpha4GateBot
    from bots.cand_361fae3f_a.connection import run_bot
    from bots.cand_361fae3f_a.learning.database import TrainingDB
...
def _load_build_order(settings: Settings, order_id: str) -> BuildOrder:
    ...
    from bots.cand_361fae3f_a.build_orders import default_4gate, load_build_orders
