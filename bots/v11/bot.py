...
from bots.v11.army_coherence import ArmyCoherenceManager
from bots.v11.build_backlog import BuildBacklog
from bots.v11.build_orders import BuildOrder
from bots.v11.claude_advisor import ClaudeAdvisor, build_prompt
from bots.v11.commands import (
    CommandExecutor,
    CommandMode,
    CommandSource,
    filter_executable,
...
from bots.v11.commands.dispatch_guard import DispatchGuard
from bots.v11.console import print_status
from bots.v11.decision_engine import DecisionEngine, GameSnapshot, StrategicState
from bots.v11.fortification import FortificationManager
from bots.v11.give_up import (
    GIVE_UP_PROB_THRESHOLD,
    GIVE_UP_WINDOW,
    should_give_up,
)
from bots.v11.learning import winprob_heuristic
from bots.v11.learning.features import _FEATURE_SPEC
from bots.v11.learning.neural_engine import DecisionMode, NeuralDecisionEngine
from bots.v11.learning.rewards import RewardCalculator
from bots.v11.learning.threat_classes import THREAT_CLASS_MAP
from bots.v11.logger import GameLogger
from bots.v11.macro_manager import MacroDecision, MacroManager
from bots.v11.micro import MicroController
from bots.v11.observer import observe
from bots.v11.scouting import ScoutManager
from bots.v11.web_socket import queue_broadcast, queue_command_event

if TYPE_CHECKING:
    from bots.v11.learning.database import TrainingDB
...
class Alpha4GateBot(BotAI):
    ...
    async def _produce_army(self) -> None:
        ...
        gas_flooding: bool = int(self.vespene) > 400
