...
from bots.v0.config import Settings, load_settings
...
def _start_server(settings: Settings, daemon: bool = False) -> None:
    ...
    from bots.v0.error_log import install_error_log_handler
    ...
    if daemon:
        from bots.v0.api import _daemon
...
def _run_batch(settings: Settings, args: argparse.Namespace) -> None:
    ...
    from bots.v0.batch_runner import load_stats, record_game, save_stats
    from bots.v0.bot import Alpha4GateBot
    from bots.v0.connection import run_bot
    from bots.v0.learning.database import TrainingDB
...
def _load_build_order(settings: Settings, order_id: str) -> BuildOrder:
    ...
    from bots.v0.build_orders import default_4gate, load_build_orders
