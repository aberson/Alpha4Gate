...
class TrainingOrchestrator:
    ...
    def run(
        ...
        """
        from bots.v0.learning.checkpoints import prune_checkpoints, save_checkpoint
    ...
    def _log_diagnostics(self, model: Any, cycle: int, win_rate: float) -> None:
        ...
        from bots.v0.learning.policy_probe import get_action_probs
    ...
    def _init_or_resume_model(self, resume: bool) -> Any:
        ...
        from bots.v0.learning.environment import SC2Env
        from bots.v0.learning.hyperparams import load_hyperparams, to_ppo_kwargs
