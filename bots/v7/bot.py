...
from bots.v7.army_coherence import ArmyCoherenceManager
from bots.v7.build_backlog import BuildBacklog
from bots.v7.build_orders import BuildOrder
from bots.v7.claude_advisor import ClaudeAdvisor, build_prompt
from bots.v7.commands import (
    CommandExecutor,
    CommandMode,
    CommandSource,
    filter_executable,
...
from bots.v7.commands.dispatch_guard import DispatchGuard
from bots.v7.console import print_status
from bots.v7.decision_engine import DecisionEngine, GameSnapshot, StrategicState
from bots.v7.fortification import FortificationManager
from bots.v7.give_up import (
    GIVE_UP_PROB_THRESHOLD,
    GIVE_UP_WINDOW,
    should_give_up,
)
from bots.v7.learning import winprob_heuristic
from bots.v7.learning.features import _FEATURE_SPEC
from bots.v7.learning.neural_engine import DecisionMode, NeuralDecisionEngine
from bots.v7.learning.rewards import RewardCalculator
from bots.v7.learning.threat_classes import THREAT_CLASS_MAP
from bots.v7.logger import GameLogger
from bots.v7.macro_manager import MacroDecision, MacroManager
from bots.v7.micro import MicroController
from bots.v7.observer import observe
from bots.v7.scouting import ScoutManager
from bots.v7.web_socket import queue_broadcast, queue_command_event

if TYPE_CHECKING:
    from bots.v7.learning.database import TrainingDB
