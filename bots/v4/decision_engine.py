...
class DecisionEngine:
    ...
    def _compute_next_state(self, snapshot: GameSnapshot) -> StrategicState:
        ...
        next_state = self._compute_next_state_inner(snapshot)

        # Track DEFEND/FORTIFY duration and force transition on timeout.
        if next_state in (StrategicState.DEFEND, StrategicState.FORTIFY):
    ...
    def _compute_next_state_inner(self, snapshot: GameSnapshot) -> StrategicState:
        """Determine the next state based on current game conditions."""
