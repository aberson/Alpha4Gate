...
class TrainingOrchestrator:
    ...
    def run(
        ...
        """
        from bots.v10.learning.checkpoints import prune_checkpoints, save_checkpoint
    ...
    def _log_diagnostics(self, model: Any, cycle: int, win_rate: float) -> None:
        ...
        from bots.v10.learning.policy_probe import get_action_probs
    ...
    def _make_env(self, db: Any) -> Any:
        ...
        soak-2026-04-11.
        """
        from bots.v10.learning.environment import SC2Env
    ...
    def _init_or_resume_model(self, resume: bool) -> Any:
        ...
        from bots.v10.learning.environment import SC2Env
        from bots.v10.learning.hyperparams import load_hyperparams, to_ppo_kwargs
    ...
    def _pick_model_class(policy_type: str, kl_coef: float) -> Any:
        ...
        from bots.v10.learning.ppo_kl import PPOWithKL, RecurrentPPOWithKL
