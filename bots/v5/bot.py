...
from bots.v5.army_coherence import ArmyCoherenceManager
from bots.v5.build_backlog import BuildBacklog
from bots.v5.build_orders import BuildOrder
from bots.v5.claude_advisor import ClaudeAdvisor, build_prompt
from bots.v5.commands import (
    CommandExecutor,
    CommandMode,
    CommandSource,
    filter_executable,
...
from bots.v5.commands.dispatch_guard import DispatchGuard
from bots.v5.console import print_status
from bots.v5.decision_engine import DecisionEngine, GameSnapshot, StrategicState
from bots.v5.fortification import FortificationManager
from bots.v5.give_up import (
    GIVE_UP_PROB_THRESHOLD,
    GIVE_UP_WINDOW,
    should_give_up,
)
from bots.v5.learning import winprob_heuristic
from bots.v5.learning.features import _FEATURE_SPEC
from bots.v5.learning.neural_engine import DecisionMode, NeuralDecisionEngine
from bots.v5.learning.rewards import RewardCalculator
from bots.v5.learning.threat_classes import THREAT_CLASS_MAP
from bots.v5.logger import GameLogger
from bots.v5.macro_manager import MacroDecision, MacroManager
from bots.v5.micro import MicroController
from bots.v5.observer import observe
from bots.v5.scouting import ScoutManager
from bots.v5.web_socket import queue_broadcast, queue_command_event

if TYPE_CHECKING:
    from bots.v5.learning.database import TrainingDB
