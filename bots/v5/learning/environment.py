...
from bots.v5.decision_engine import (
...
from bots.v5.learning.features import FEATURE_DIM, encode
from bots.v5.learning.rewards import RewardCalculator
from bots.v5.learning.winprob_heuristic import score as _winprob_score
...
class SC2Env(gymnasium.Env[NDArray[np.float32], int]):
    ...
    def reset(
        ...
        *,
        ...
        if _replay_dir is not None:
            from bots.v5.connection import build_replay_path
    ...
    def _sync_game(
        ...
        if _db_write_ok and _stats_path is not None:
            try:
                from bots.v5.batch_runner import GameRecord, append_stats_game
...
def _make_training_bot(
    ...
    from bots.v5.build_orders import default_4gate
