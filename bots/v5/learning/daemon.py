...
class TrainingDaemon:
    ...
    def _get_rollback_monitor(self) -> Any:
        ...
        if self._rollback_monitor is None:
            from bots.v5.learning.database import TrainingDB
            from bots.v5.learning.rollback import RollbackConfig, RollbackMonitor
    ...
    def _start_watchdog(self) -> None:
        ...
        """
        from bots.v5.error_log import get_error_log_buffer
    ...
    def _run_training(self) -> None:
        ...
        try:
            ...
            from bots.v5.learning.advisor_bridge import (
