...
class TrainingDaemon:
    ...
    def _get_rollback_monitor(self) -> Any:
        ...
        if self._rollback_monitor is None:
            from bots.v9.learning.database import TrainingDB
            from bots.v9.learning.rollback import RollbackConfig, RollbackMonitor
    ...
    def _start_watchdog(self) -> None:
        ...
        """
        from bots.v9.error_log import get_error_log_buffer
    ...
    def _run_training(self) -> None:
        ...
        try:
            ...
            from bots.v9.learning.advisor_bridge import (
