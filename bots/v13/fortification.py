...
from bots.v13.macro_manager import MacroDecision
    ...
    async def auto_battery(self, bot: BotAI) -> None:
        ...
        for nexus in bot.townhalls.ready:
            ...
            if tag in self._battery_placed_nexus_tags:
                continue
            if not bot.can_afford(UnitTypeId.SHIELDBATTERY):
                continue
            near_pt = nexus.position.towards(bot.game_info.map_center, 2.0)
