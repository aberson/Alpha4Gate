...
from bots.v13.army_coherence import ArmyCoherenceManager
from bots.v13.build_backlog import BuildBacklog
from bots.v13.build_orders import BuildOrder
from bots.v13.claude_advisor import ClaudeAdvisor, build_prompt
from bots.v13.commands import (
    CommandExecutor,
    CommandMode,
    CommandSource,
    filter_executable,
...
from bots.v13.commands.dispatch_guard import DispatchGuard
from bots.v13.console import print_status
from bots.v13.decision_engine import DecisionEngine, GameSnapshot, StrategicState
from bots.v13.fortification import FortificationManager
from bots.v13.give_up import (
...
from bots.v13.macro_manager import MacroDecision, MacroManager
from bots.v13.micro import MicroController
from bots.v13.observer import observe
from bots.v13.scouting import ScoutManager
from bots.v13.web_socket import queue_broadcast, queue_command_event
...
class Alpha4GateBot(BotAI):
    ...
    async def on_step(self, iteration: int) -> None:
        ...
        self._dispatch_guard.set_emergency_mode(state == StrategicState.DEFEND)
