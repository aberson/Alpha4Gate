...
from bots.v2.army_coherence import ArmyCoherenceManager
from bots.v2.build_backlog import BuildBacklog
from bots.v2.build_orders import BuildOrder
from bots.v2.claude_advisor import ClaudeAdvisor, build_prompt
from bots.v2.commands import (
    CommandExecutor,
    CommandMode,
    CommandSource,
    filter_executable,
...
from bots.v2.commands.dispatch_guard import DispatchGuard
from bots.v2.console import print_status
from bots.v2.decision_engine import DecisionEngine, GameSnapshot, StrategicState
from bots.v2.fortification import FortificationManager
from bots.v2.learning.features import _FEATURE_SPEC
from bots.v2.learning.neural_engine import DecisionMode, NeuralDecisionEngine
from bots.v2.learning.rewards import RewardCalculator
from bots.v2.learning.threat_classes import THREAT_CLASS_MAP
from bots.v2.logger import GameLogger
from bots.v2.macro_manager import MacroDecision, MacroManager
from bots.v2.micro import MicroController
from bots.v2.observer import observe
from bots.v2.scouting import ScoutManager
from bots.v2.web_socket import queue_broadcast, queue_command_event

if TYPE_CHECKING:
    from bots.v2.learning.database import TrainingDB
...
class Alpha4GateBot(BotAI):
    ...
    async def _run_scouting(self) -> None:
        ...
        # Clear dead scout (resets timer so a new scout is assigned immediately)
        self.scout_manager.check_scout_alive(self)
