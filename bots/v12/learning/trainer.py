...
class TrainingOrchestrator:
    ...
    def run(
        ...
        """
        from bots.v12.learning.checkpoints import prune_checkpoints, save_checkpoint
    ...
    def _log_diagnostics(self, model: Any, cycle: int, win_rate: float) -> None:
        ...
        from bots.v12.learning.policy_probe import get_action_probs
    ...
    def _pick_model_class(policy_type: str, kl_coef: float) -> Any:
        ...
        from bots.v12.learning.ppo_kl import PPOWithKL, RecurrentPPOWithKL
