...
from bots.v12.config import Settings, load_settings
...
def _ensure_pretrain_checkpoint(settings: Settings, hyperparams_path: Path) -> None:
    ...
    from bots.v12.learning.imitation import run_imitation_training
...
def _run_training(settings: Settings, args: argparse.Namespace) -> None:
    ...
    if args.train == "imitation":
        ...
        from bots.v12.learning.trainer import TrainingOrchestrator
...
def _start_server(settings: Settings, daemon: bool = False) -> None:
    ...
    from bots.v12.api import configure
    from bots.v12.error_log import install_error_log_handler
    ...
    if daemon:
        from bots.v12.api import _daemon
...
def _run_single_game(
    ...
    *,
    ...
    from bots.v12.bot import Alpha4GateBot
    from bots.v12.connection import run_bot
    from bots.v12.learning.neural_engine import DecisionMode
    ...
    if args.no_claude:
        ...
        from bots.v12.api import ws_manager
        from bots.v12.claude_advisor import ClaudeAdvisor
...
def _run_batch(settings: Settings, args: argparse.Namespace) -> None:
    ...
    from bots.v12.batch_runner import load_stats, record_game, save_stats
    from bots.v12.bot import Alpha4GateBot
    from bots.v12.connection import run_bot
    from bots.v12.learning.database import TrainingDB
...
def _load_build_order(settings: Settings, order_id: str) -> BuildOrder:
    ...
    from bots.v12.build_orders import default_4gate, load_build_orders
