...
from bots.cand_4280017f_a.decision_engine import (
...
from bots.cand_4280017f_a.learning.features import FEATURE_DIM, encode
...
class SC2Env(gymnasium.Env[NDArray[np.float32], int]):
    ...
    def reset(
        ...
        *,
        ...
        if _replay_dir is not None:
            from bots.cand_4280017f_a.connection import build_replay_path
    ...
    def _sync_game(
        ...
        if _db_write_ok and _stats_path is not None:
            try:
                from bots.cand_4280017f_a.batch_runner import GameRecord, append_stats_game
...
def _make_training_bot(
    ...
    from bots.cand_4280017f_a.build_orders import default_4gate
