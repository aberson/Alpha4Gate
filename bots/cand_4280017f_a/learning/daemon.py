...
class TrainingDaemon:
    ...
    def _get_rollback_monitor(self) -> Any:
        ...
        if self._rollback_monitor is None:
            from bots.cand_4280017f_a.learning.database import TrainingDB
            from bots.cand_4280017f_a.learning.rollback import RollbackConfig, RollbackMonitor
    ...
    def _start_watchdog(self) -> None:
        ...
        """
        from bots.cand_4280017f_a.error_log import get_error_log_buffer
    ...
    def _run_training(self) -> None:
        ...
        try:
            ...
            from bots.cand_4280017f_a.learning.advisor_bridge import (
