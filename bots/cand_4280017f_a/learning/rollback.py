...
class RollbackMonitor:
    ...
    def check_for_regression(self, current_best: str) -> RollbackDecision | None:
        ...
        """
        from bots.cand_4280017f_a.learning.checkpoints import _load_manifest
    ...
    def execute_rollback(self, decision: RollbackDecision) -> None:
        ...
        """
        from bots.cand_4280017f_a.learning.checkpoints import _load_manifest, _save_manifest
