...
from bots.cand_4280017f_a.army_coherence import ArmyCoherenceManager
from bots.cand_4280017f_a.build_backlog import BuildBacklog
from bots.cand_4280017f_a.build_orders import BuildOrder
from bots.cand_4280017f_a.claude_advisor import ClaudeAdvisor, build_prompt
from bots.cand_4280017f_a.commands import (
    CommandExecutor,
    CommandMode,
    CommandSource,
    filter_executable,
...
from bots.cand_4280017f_a.commands.dispatch_guard import DispatchGuard
from bots.cand_4280017f_a.console import print_status
from bots.cand_4280017f_a.decision_engine import DecisionEngine, GameSnapshot, StrategicState
from bots.cand_4280017f_a.fortification import FortificationManager
from bots.cand_4280017f_a.learning.features import _FEATURE_SPEC
from bots.cand_4280017f_a.learning.neural_engine import DecisionMode, NeuralDecisionEngine
from bots.cand_4280017f_a.learning.rewards import RewardCalculator
from bots.cand_4280017f_a.learning.threat_classes import THREAT_CLASS_MAP
from bots.cand_4280017f_a.logger import GameLogger
from bots.cand_4280017f_a.macro_manager import MacroDecision, MacroManager
from bots.cand_4280017f_a.micro import MicroController
from bots.cand_4280017f_a.observer import observe
from bots.cand_4280017f_a.scouting import ScoutManager
from bots.cand_4280017f_a.web_socket import queue_broadcast, queue_command_event

if TYPE_CHECKING:
    from bots.cand_4280017f_a.learning.database import TrainingDB
    ...
    async def _run_micro(self, state: StrategicState) -> None:
        ...
        for cmd in commands:
            ...
            if cmd.action == "attack" and cmd.target_tag is not None:
                ...
                if _should_reissue_attack_to_position(unit, pos):
                    unit.attack(pos)
            elif cmd.action == "blink" and cmd.target_position is not None:
                unit(AbilityId.EFFECT_BLINK_STALKER, Point2(cmd.target_position))
