...
- **Type:** wait
- **Issue:** #265
- **Status:** DONE (2026-05-03) — PARTIAL PASS. Soak ran 2026-05-02 across two evolve invocations, 2 promotions fired (v10→v11, v11→v12). Promotion-side criteria fully met: lineage updated within 60s of each promotion, weight_dynamics rows appeared within 8-9s. Dashboard healthy throughout. **Live Runs accuracy criterion failed** due to Defect #268 — single-concurrency runs invisible to `/api/runs/active`. Two other defects logged: #267 (cosmetic chips) and #269 (lineage attribution loss). Soak report: [documentation/soak-test-runs/models-tab-observation-2026-05-02.md](../soak-test-runs/models-tab-observation-2026-05-02.md).
