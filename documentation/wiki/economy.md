...
| `bots/v0/build_orders.py` | BuildOrder, BuildStep, BuildSequencer |
| `bots/v0/build_backlog.py` | Retry queue for failed builds |
| `bots/v0/fortification.py` | Static defense scaling |
