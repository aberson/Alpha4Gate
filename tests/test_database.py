...
class TestStoreAndRetrieve:
    ...
    def test_store_transition(self, db: TrainingDB) -> None:
        db.store_game("g1", "Simple64", 1, "win", 300.0, 5.5, "v0")
        state = np.array([50, 100, 800, 400, 30, 22, 2, 1, 15, 60.0, 300, 3, 1, 1, 2], dtype=np.float32)
        next_s = np.array([55, 100, 700, 350, 35, 23, 2, 0, 10, 82.0, 322, 3, 1, 1, 2], dtype=np.float32)
