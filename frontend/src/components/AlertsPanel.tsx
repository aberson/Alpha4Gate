  ...
  return (
    <div className="alerts-panel training-dashboard">
      ...
      <p style={{ color: "#888", fontSize: "0.85em", margin: "0 0 16px" }}>
        System alerts and error notifications generated by rule-based monitors (win-rate drops, daemon errors, stale data, etc.). Ack an alert to de-emphasize it while keeping it visible; Dismiss removes it from the active list entirely.
      </p>
